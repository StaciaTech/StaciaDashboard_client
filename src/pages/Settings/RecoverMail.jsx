...
function RecoverMail({ closeRecoverMail }) {
          ...
          <div>
            <div className="modal-contaier">
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div style={{ color: "#000" }}>Recover Mail</div>
                <div onClick={closeRecoverMail}>X</div>
              </div>
              <p>
                Add a recovery mail to ensure account access even if you forget
                your password. It's a simple and secure way to keep your account
                in your hands
              </p>
              <input
                type="text"
        ...
        {success && (
          ...
          >
            ...
            >
              ...
              >
                Recovery Mail Updated!
              </div>
              <div style={{ textAlign: "center", color: "#787878" }}>
                Success! Your recovery mail has been updated. You're all set for
                secure and hassle-free account access
              </div>
            </div>

            <buttom className="modal-submit-button" onClick={closeRecoverMail}>
              Done
            </buttom>
          </div>
        )}
