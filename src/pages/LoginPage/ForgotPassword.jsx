    ...
    const verifyEmail = () => {
      {
        ...
        axios
          .post(`${apiUrl}/admin/forgotpassword`, userData)
          .then((response) => {
        ...
        <div className="loginright">
          <div className="text-container">
            ...
            <div className="header-secondary">
              ...
              address associated with your account below
            </div>
    ...
    const VerifyOtpFunction = () => {
      {
        ...
        axios.post(`${apiUrl}/admin/verify-otp`, userData).then((response) => {
          console.log(response, response.status, response.data);
          if (response.data.success) {
            alert(response.data.message);
            SetOtp(tempOtp);
      ...
      <div className="logincontainer">
        ...
        <div className="loginright">
          <div className="text-container">
            ...
            <div className="header-secondary">
              We've sent a one-time password ( 6 digit ) to your registered
              mobile number or email address. Please enter the OTP below to
              proceed
            </div>
  ...
  function CreatePassword() {
    ...
    const resetPasswordFuntion = () => {
      if (
        ...
        axios
          .post(`${apiUrl}/admin/reset-password`, userData)
          .then((response) => {
            console.log(response, response.status, response.data);
            if (response.data.success) {
              alert(response.data.message);
